...
KAFKA_OPTS="$KAFKA_OPTS -javaagent:$KAFKA_HOME_DIR/jmx_prometheus_javaagent-0.12.0.jar=$PROMETHEUS_PORT:$KAFKA_HOME_DIR/kafka-0-8-2.yml" "$KAFKA_HOME_DIR/bin/kafka-server-start.sh" /etc/kafka/server.properties
